...
// POST 
document.querySelector('.actors-form').addEventListener('submit', async (event) => {
...
document.addEventListener('click', async (event) => {
  if (event.target.closest('.edit-btn')) {
    ...
    document.getElementById('editActorName').value = row.children[1].textContent.trim();
    document.getElementById('editActorSurname').value = row.children[2].textContent.trim();
    document.getElementById('editActorImgUrl').value = row.children[3].querySelector('img').src;
...
document.getElementById('saveEditActorBtn').addEventListener('click', async () => {
  const id = document.getElementById('saveEditActorBtn').getAttribute('data-id');
